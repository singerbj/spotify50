(function() {
  ...
  if (!params.access_token) {
    window.location = 'https://accounts.spotify.com/authorize?client_id=' + clientId + '&response_type=token&redirect_uri=http:%2F%2F' + window.location.hostname + ':8080%2F&scope=' + scopes;
  } else {
